...
import com.konorat.cursomc.domain.Estado;
import com.konorat.cursomc.domain.ItemPedido;
import com.konorat.cursomc.domain.Pagamento;
import com.konorat.cursomc.domain.PagamentoComBoleto;
import com.konorat.cursomc.domain.PagamentoComCartao;
...
import com.konorat.cursomc.repositories.EstadoRepository;
import com.konorat.cursomc.repositories.ItemPedidoRepository;
import com.konorat.cursomc.repositories.PagamentoRepository;
import com.konorat.cursomc.repositories.PedidoRepository;
import com.konorat.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "konorat.matheus@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));		
		...
		Cliente cli2 = new Cliente(null, "Ana Konorat ADM", "matheusjavabsi@gmail.com", "79597956063", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("33333333", "44444444"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e3 = new Endereco(null, "Rua dos joinvillenses", "125", "Apto 101", "Jardim Brasil", "32041010", cli2, c1);
		Endereco e4 = new Endereco(null, "Avenida do meu bom", "123", null, "avai", "10181011", cli2, c2);
